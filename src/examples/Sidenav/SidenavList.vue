    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="this.$store.state.isRTL ? '' : 'Users'"
        >
          <template v-slot:icon>
            <i
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="this.$store.state.isRTL ? '' : 'Add User'"
        >
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item
          url="/updateuser"
          :class="getRoute() === 'updateuser' ? 'active' : ''"
          :navText="
            this.$store.state.isRTL ? '' : 'Update User'
          "
        >
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item
          url="/deleteuser"
          :class="getRoute() === 'deleteuser' ? 'active' : ''"
          :navText="
            this.$store.state.isRTL ? '' : 'Delete User'
          "
        >
          <template v-slot:icon>
